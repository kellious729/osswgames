...
while True:
    ...
    if changeto=='DOWN' and not direction=='UP':
        direction='DOWN'
    if changeto=='L' and not direction=='J':
        direction='L'
    if changeto=='J' and not direction=='L':
        direction='J'
    if changeto=='I' and not direction=='K':
        direction='I'
    if changeto=='K' and not direction=='I':
        direction='K'
    ...
    or snakePos1[0]==foodPos[0] and snakePos1[1]==foodPos[1]:
    ...
    or  snakePos1[0]==foodPos1[0] and snakePos11]==foodPos1[1]:
        pygame.mixer.Sound.play(snakebit_sound)
        x-=1
        score+=1
        foodSpawn1=False
    ...
    or snakePos1[0]==foodPos2[0] and snakePos1[1]==foodPos2[1]:
        pygame.mixer.Sound.play(snakebit_sound)
        score+=2
        foodSpawn2=False
    ...
    for block in snakeBody[1:]:
        ...
        or snakePos1[0]==block[0] and snakePos1[1]==block[1]:
            pygame.mixer.music.stop()
            pygame.mixer.Sound.play(crash_sound)
            time.sleep(1)
            gameOver()
